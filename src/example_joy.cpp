...
#include <std_msgs/msg/int32.hpp>
  ...
  #include "joy/ps5.hpp"
  using namespace ps5;
#elif JOY_VERSION == MAC_PS5
  #include "joy/mac_ps5.hpp"
  using namespace ps5;
...
public:
  ...
  void sub_joy_thread(const sensor_msgs::msg::Joy::SharedPtr msg)
  {
    ...
    std::cout << std::endl;
    #if !defined(PS5) && !defined(MAC_PS5)
  ...
  : Node("joy_test", options)
  {
    ...
    sub_joy =
      ...
      "/joy", 1,
      [this](const sensor_msgs::msg::Joy::SharedPtr msg){ sub_joy_thread(msg); }
    );
